...
st.subheader("1️. Nutri-Score Distribution")
...
st.subheader("2️. Top 10 Healthiest Brands")
fig, ax = plt.subplots(figsize=(10, 6))
...
st.subheader("3️. Sugar Content by Category")
...
st.subheader("4️. Protein vs Fat Content")
...
st.subheader("5️. Nutri-Score vs Eco-Score")
...
st.subheader("6️. Calories by Processing Level")
...
st.subheader("7️. High-Sugar Products by Country")
...
with col1:
    st.subheader("8️. Organic vs Nutri-Score")
...
with col2:
    st.subheader("9️. Ultra-Processed Share")
